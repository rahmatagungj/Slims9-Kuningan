...
<section class="mt-5 container">
    <h4 class="text-secondary text-center text-thin mt-5 mb-4">Topik Pilihan</h4>
...
<section class="mt-5 container">
    <h4 class=" mb-4">
        ...
        <br>
        <small class="subtitle-section">Koleksi berikut ini adalah buku paling banyak digunakan.</small>
    </h4>
...
<section class="mt-5 bg-white">
    <div class="container py-5">
        <h4 class="mb-4">
            Pembaca teratas tahun ini.
            <br>
            <small class="subtitle-section">Pengguna terbaik kami, pembaca, sejauh ini. Lanjutkan membaca jika Anda ingin nama Anda disebutkan di sini.</small>
        </h4>
        <div class="flex flex-wrap">
          ...
          foreach ($members as $member) {
            ...
            $m .= '<p class="card-text text-center"><b>'.$member['total'].'</b> <span class="text-grey-darker">Pinjaman</span><span style="width: 1px" class="inline-block h-4 mx-3 relative bg-grey align-middle"></span><b>'.$member['total_title'].'</b> <span class="text-grey-darker">Judul</span></p>';
            $m .= '</div>';
            $m .= '</div>';
            $m .= '</div>';
...
<section class="mt-5 container">
    <h4 class=" mb-4">
        Koleksi terbaru.
        <br>
        <small class="subtitle-section">Ini adalah daftar koleksi baru. Semoga Anda menyukainya..</small>
    </h4>
    <div class="d-flex flex-wrap">
      <?php
      // ------------------------------------------------------------------------
