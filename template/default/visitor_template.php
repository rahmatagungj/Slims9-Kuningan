...
<div class="flex h-screen w-full" id="visitor-counter" style="background: rgba(0,0,0,0.3)">
    <div class="bg-white w-full md:w-1/3 px-8 pt-8 pb-3 flex flex-col justify-between">
        <div>
            <h3 class="font-light mb-2"><center>Selamat Datang di <br> <?= $sysconf['library_name']; ?></h3>
            <p class="lead">
                Silahkan masukkan nomor anggota Anda atau masukkan nama lengkap Anda.
            </p>
            ...
            <form class="mt-4" @submit.prevent="onSubmit">
                <div class="form-group">
                    <label for="exampleInputEmail1">ID ANGGOTA / NAMA PENGUNJUNG</label>
                ...
                <div class="form-group">
                    ...
                    <small id="emailHelp" class="form-text text-muted">Cukup mengisi ID anggota Anda jika Anda adalah anggota  <?= $sysconf['library_name']; ?></small>
                </div>
                <button type="submit" class="btn btn-primary btn-block">MASUK</button>
            </form>
        </div>
        <div class="text-right">
            <small class="text-grey-dark">Supported by <code>SOLID Kuningan</code></small> | <small class="text-grey-dark">Powered by <code>SLiMS</code></small>
        </div>
    </div>
