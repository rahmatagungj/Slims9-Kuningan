...
$sysconf['print']['membercard']['front_side_image'] = 'bgku.jpg';
...
//Label Barcode Logo Warna
		$sysconf['print']['barcode']['barcode_header_text1']= '<u><b>Perpustakaan SD AL-Jannah</b><u>'; // Nama lembaga induk
		$sysconf['print']['barcode']['barcode_header_text2'] = 'Islamic, Nature & Science School';  // Unit lembaga
		$sysconf['print']['barcode']['barcode_header_text3'] = 'JL. Jambore 4 Cibubur, Jakarta Timur 50272'; // Alamat
		$sysconf['print']['barcode']['barcode_call_number_style']='font-size: 18pt; font-weight:bold; text-align:left; padding-left:90px; font:Arial'; //Style Call Number
