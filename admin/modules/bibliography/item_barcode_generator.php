            ...
            if ($sysconf['print']['barcode']['barcode_include_header_text']) {  }
				  ...
				  //Mengatur kolom barcode
				   if ($sysconf['print']['barcode']['barcode_cut_title']) {         			
				    ...
				    $html_str .= '</td>';
				 $html_str .='<td style="background-color:'.$warna.'; border-bottom:0px solid #000000;"><center><div style="font-size: 9pt; ; padding-left: 25; font-weight:bold;">'.($sysconf['print']['barcode']['barcode_header_text1']).'</div><div style="font-size: 10pt;padding-left:20px; font-weight:none;">'.($sysconf['print']['barcode']['barcode_header_text2']).'</div><div style="font-size: 8pt; padding-left: 15px">'.($sysconf['print']['barcode']['barcode_header_text3']).'</div>';
				  $html_str .= '</td>';
				  if ($sysconf['print']['barcode']['barcode_cut_title']) {         			
				  	$html_str .= '<td rowspan="2" style="border-left: '.$sysconf['print']['barcode']['barcode_border_size'].'px solid #000000; padding-left:0.5cm; padding-top:2.5cm;"><div class="barcode_rotate">'.'<div style="font-size: 8pt; width: 3.5cm;">'.substr($barcode[0], 0, $sysconf['print']['barcode']['barcode_cut_title']).'...</div>'.'<img src="'.SWB.IMG.'/barcodes/'.str_replace(array(' '), '_', $barcode[1]).'.png" style="width: 5cm; height: 2.5cm; border="0"/>';
					} else { $html_str .= $barcode[0]; }
				  $html_str .= '</td></tr>';
				  $html_str .= '<tr><td>';
